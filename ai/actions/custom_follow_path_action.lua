...
local ArchipelagoFollowPathAction = radiant.class()

--same as ace. needed to make them climb other vertical things that are not just ladders

function ArchipelagoFollowPathAction:run(ai, entity, args)
...
return ArchipelagoFollowPathAction